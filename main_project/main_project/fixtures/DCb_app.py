...
class Checkout(BaseApp):
    def __init__(self, base_url="http://development.nxte.nl/Cadeau_Concepten/CACO1621-DinerCadeau"):
        super().__init__(base_url)

    # http://development.nxte.nl/Cadeau_Concepten/CACO1621-DinerCadeau
    # https://diner-cadeaube.testconcepten.nl
